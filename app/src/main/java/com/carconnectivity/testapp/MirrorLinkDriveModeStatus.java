...
public class MirrorLinkDriveModeStatus extends BaseActivity {
	
	private String LOG_TAG = getClass().getCanonicalName(); 
	
	SuccesView driveModeEnabled= null;
		...
		public void onDriveModeChange(final boolean driveMode) throws RemoteException {
			runOnUiThread(new Runnable() {
				...
				public void run() {
					...
					driveModeEnabled.setValue(driveMode);
	...
	ScrollView buildUI()
	{
		...
		driveModeEnabled= new SuccesView(this,"Drive mode enabled",false);
		layout.addView(driveModeEnabled);
