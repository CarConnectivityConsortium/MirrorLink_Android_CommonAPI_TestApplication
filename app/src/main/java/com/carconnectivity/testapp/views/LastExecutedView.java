...
public class LastExecutedView  extends LinearLayout{
	TextView tTimeStamp = null;

	
	public LastExecutedView(Context context) {
		super(context);
		View.inflate(context, R.layout.view_last_executed, this);
