...
public class MirrorLinkDriveModeScreenTests extends BaseFunctionalTests {

	public MirrorLinkDriveModeScreenTests() {
		super();
		testedActivity = MirrorLinkDriveModeScreen.class;
	}
} 